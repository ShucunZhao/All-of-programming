...
int main(int argc, char ** argv){
	...
	L2.printData();
	//Overload operator <<
	cout<<"L2 with operator <<:"<<endl;
	cout<<L2<<endl;
	DoubleLinkedList<int> * rev = L2.reverse();	
	cout<<"L2 after reverse:"<<endl;
	cout<<*rev<<endl;
	delete rev;
	/*
	//constIterator part:
	cout<<"L2 with const_iterator:"<<endl;
	DoubleLinkedList<int>::const_iterator it = L2.beginC();
	while(it!=L2.endC()){
		cout<<*it<<endl;
		++it;
	}
	*/
	/*
	cout<<"L2 with const_iterator:"<<endl;
	DoubleLinkedList<int>::const_iterator itCon = L2.beginC();
	cout<<*itCon<<endl;
	*/
