...
run_test(){
    ...
    do
	IFS=" " correct=`/home/ShucunZhao/Codes/C++/All_of_programming/Duke-ECE551/Homeworks/024_testing2/match5/correct-match5 $line 2>&1`
...
found=0
notfound=0
for i in /home/ShucunZhao/Codes/C++/All_of_programming/Duke-ECE551/Homeworks/024_testing2/match5/match5-*
do
